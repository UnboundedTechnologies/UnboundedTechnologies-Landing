            ...
            {ENGAGEMENTS.map((e, i) => {
              ...
              return (
                <article
                  key={e.titleKey}
                  className={cn(
                    'group relative overflow-hidden backdrop-blur-xl backdrop-saturate-150 bg-bg-elevated/70 border border-white/[0.08] rounded-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_8px_24px_-12px_rgba(0,0,0,0.4)]',
