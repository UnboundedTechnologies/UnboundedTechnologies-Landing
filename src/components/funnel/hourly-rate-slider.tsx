    ...
    <div className="space-y-3">
      ...
      <input
        ...
        className={cn(
          ...
          // Bigger thumb on mobile (touch fingers are imprecise) and a
          // moderate size on desktop where mouse precision is fine.
          '[&::-webkit-slider-thumb]:h-6 [&::-webkit-slider-thumb]:w-6 md:[&::-webkit-slider-thumb]:h-5 md:[&::-webkit-slider-thumb]:w-5',
          '[&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-white',
          '[&::-webkit-slider-thumb]:border-2 [&::-webkit-slider-thumb]:border-brand-blue',
          '[&::-webkit-slider-thumb]:-mt-[10px] md:[&::-webkit-slider-thumb]:-mt-[7px]',
          ...
          '[&::-moz-range-thumb]:h-6 [&::-moz-range-thumb]:w-6 md:[&::-moz-range-thumb]:h-5 md:[&::-moz-range-thumb]:w-5',
